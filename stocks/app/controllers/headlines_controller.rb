...
class HeadlinesController < ApplicationController 
    ...
    def search
        params[:query]
        stockTwits = HTTParty.get('https://api.stocktwits.com/api/2/streams/trending.json')
        quote = HTTParty.get("https://api.iextrading.com/1.0/stock/#{params[:query]}/quote?displayPercent=true")
        company = HTTParty.get("https://api.iextrading.com/1.0/stock/#{params[:query]}/company")
        keystats = HTTParty.get("https://api.iextrading.com/1.0/stock/#{params[:query]}/stats")
        financials = HTTParty.get("https://api.iextrading.com/1.0/stock/#{params[:query]}/financials")
        logo = HTTParty.get("https://api.iextrading.com/1.0/stock/#{params[:query]}/logo")
        single_stock_news = HTTParty.get("https://api.iextrading.com/1.0/stock/#{params[:query]}/news/last/6")
